...
function _render() {
	...
	var signIn_button = createButton("buttonContainer", buttonIn, "Авторизация", "ProcessAutorization()", undefined);
	var signUp_button = createButton("buttonContainer", buttonUp, "Регистрация", "ProcessRegistrationForm()", undefined);
