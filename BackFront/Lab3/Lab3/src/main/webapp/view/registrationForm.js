...
function _render() {
	...
	var reg_button = createButton("buttonContainer", buttonIn, "Продолжить", "ProcessRegistration()", undefined);
	var back_button = createButton("buttonContainer", buttonBack, "Назад", "ProcessAutorizationForm()", undefined);
