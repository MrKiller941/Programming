...
class BaseEnemy(BaseCharacter):
    ...
    def hit(self, target): # удар персонажем 
...
weapon4 = Weapon("Лазерная орбитальная пушка", 200,200)
princess = BaseCharacter(100, 100, 100)
archer = BaseEnemy(50, 50, weapon3, 100)
armored_swordsman = BaseEnemy(10, 10, weapon2, 100)
archer.hit(armored_swordsman)
armored_swordsman.move(10, 10)
print(armored_swordsman.get_coords())
main_hero = MainHero(0, 0, "Король Андрей", 50)
